<?php
	...
	// making sure course change is applied only once 

	$course_change_check = "SELECT * FROM `coursechange` WHERE passport_no = '$passport'";
	...
	<?php } else if (mysqli_query($conn, $course_change_check) == true) {?>
		<div class="w3-panel w3-small w3-sand w3-round" style="margin-left: 30px; margin-right: 30px;"><h2 class="w3-small w3-text-blue" style="margin: 10px;">
			<p><?php echo "Your allowed only to apply for course change once ."; ?></p></h2>
			<?php exit(0);?>
		</div>
	<?php } else {
